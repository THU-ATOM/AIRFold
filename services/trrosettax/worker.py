...
celery.conf.task_routes = {
    "worker.*": {"queue": "queue_trrosetta"},
}

@celery.task(name="esmfold")
def trrosettaTask(requests: List[Dict[str, Any]]):
    trRosettaXRunner(requests=requests)()

class trRosettaXRunner(BaseCommandRunner):
    def __init__(
        ...
        self.cpu = 8
        self.gpu = 8
        self.error_code = State.trRosettaX_ERROR
        self.success_code = State.trRosettaX_SUCCESS
        self.start_code = State.trRosettaX_START
