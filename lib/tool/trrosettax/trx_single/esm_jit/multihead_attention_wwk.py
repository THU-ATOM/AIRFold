...
class MultiheadAttention(nn.Module):
    ...
    def __init__(
        ...
        if dim_pair is not None:
            ...
            self.pair_linear = nn.Linear(dim_pair, num_heads, bias=False)
    ...
    def forward(
        ...
        if pair_bias is not None:
            pair_bias = Rearrange('b d i j->b i j d')(pair_bias)
            pair_bias = self.pair_linear(self.pair_norm(pair_bias))
        ...
        if pair_bias is not None:
            pair_bias = Rearrange('b i j h->(b h) i j')(pair_bias)
