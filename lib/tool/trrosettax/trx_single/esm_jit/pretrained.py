...
def load_model_and_alphabet_core(model_data, cuda_lst=None, regression_data=None):
    ...
    alphabet = esm_jit.Alphabet.from_architecture(model_data["args"].arch)
    ...
    if model_data["args"].arch == 'roberta_large':
        ...
        model_type = esm_jit.ProteinBertModel
        ...
        model_type = esm_jit.MSATransformer
...
def init_model_and_alphabet(args_json, cuda_lst=None):
    ...
    # esm_jit.ProteinBertModel.add_args(parser)
    # args = parser.parse_args()
    alphabet = esm_jit.Alphabet.from_architecture('roberta_large')
    model = esm_jit.ProteinBertModel(args=args, alphabet=alphabet)
