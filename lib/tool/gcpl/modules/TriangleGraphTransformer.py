...
from lib.tool.gcpl.modules.GraphTransformer import GraphTransformer
from lib.tool.gcpl.modules.TriangleMultiplicativeModule import TriangleMultiplicativeModule
