...
#___a reformat for .sto files to fasta and a3m files_________
import os
import sys
...
def _validate_input(inputfile, outputfile):
    ...
    if isinstance(inputfile, basestring) or isinstance(inputfile, PosixPath):
    ...
    if isinstance(outputfile, basestring) or isinstance(outputfile, PosixPath):
