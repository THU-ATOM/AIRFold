...
params_dict = {'voronota_exec': '/data/protein/datasets_2024/enqa/utils/SGCN/bin/voronota-linux',
               ...
               'meta_atom_types': '/data/protein/datasets_2024/enqa/utils/SGCN/metadata/protein_atom_types.txt',
               'meta_bond_types': '/data/protein/datasets_2024/enqa/utils/SGCN/metadata/bond_types.csv',
               'VORONOTA_RADII': '/data/protein/datasets_2024/enqa/utils/SGCN/metadata/voronota_radii.txt',
               'ELEMENTS_RADII': '/data/protein/datasets_2024/enqa/utils/SGCN/metadata/elements_radii.txt',
